...
class TaskAdapter(private val header: Array<String>, private val description: Array<String>, private var isDark : Boolean) : RecyclerView.Adapter<TaskAdapter.LessonAndTaskViewHolder>() {
    ...
    class LessonAndTaskViewHolder(itemView: View, isDark : Boolean) : RecyclerView.ViewHolder(itemView) {
        ...
        private var constraintLayout : ConstraintLayout? = itemView.container
